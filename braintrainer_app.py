...
# Streamlit-app
st.title("🧠 HBO Braintrainer - Thema's & Moeilijkheidsniveaus")
...
niveau = st.selectbox("Kies moeilijkheidsgraad:", [1, 2, 3], format_func=lambda x: {1: "MBO", 2: "HBO", 3: "Universitair"}[x])
